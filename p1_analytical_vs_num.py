####################################################
# THERMAL EXPANSION - LINEAR ELASTICITY (P1: ANALYTICAL VS NUMERICAL)
####################################################
...
plotter.open_gif("P1_deformation.gif", fps=3)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("P1_analytical_vs_numerical.png", dpi=300)
plt.close()
