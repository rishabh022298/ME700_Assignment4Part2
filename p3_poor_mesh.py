####################################################
# THERMAL EXPANSION - LINEAR ELASTICITY (P3: POOR MESH)
####################################################
...
plotter.open_gif("P3_poor_mesh_deformation.gif", fps=3)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("P3_poor_mesh_axial_displacement_comparison.png", dpi=300)
plt.close()
